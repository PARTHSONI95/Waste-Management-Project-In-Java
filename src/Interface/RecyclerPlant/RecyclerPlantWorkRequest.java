 ...
 * @author ABC
 */
public class RecyclerPlantWorkRequest extends javax.swing.JPanel {
    ...
    public RecyclerPlantWorkRequest(JPanel userProcessContainer, LoggedUserDTO loggedUser) {
        initComponents();
    ...
    public void populateRPWorkQ(){
        
      ProcessDao pDao = new ProcessDao();
      List<RequestDTO> resultList = pDao.getUnitWorkQ(loggedUser.getUserName(), "RecPlant");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Recycler Plant Work Request Queue");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(selectedRow < 0){
            ...
            //} else {
                 ...
                 RecyclerPlantReqAction qaObj = new RecyclerPlantReqAction(userProcessContainer, (RequestDTO) workreq, loggedUser);
                 userProcessContainer.add("RecyclerPlantReqAction", qaObj);
